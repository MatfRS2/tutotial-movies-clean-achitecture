...
namespace Movies.Domain.PripremaContext.FilmAggregate;
...
public class Film : EntityBase, IAggregateRoot
{
  ...
  public void IzmeniNaslov(string noviNaslov)
  {
    Naslov = Guard.Against.NullOrEmpty(noviNaslov, nameof(noviNaslov));
  }
